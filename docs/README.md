...
If we ever just need to slightly edit the showcase then this is raw copy-paste for them :D
Use `!say` command.

* [Spectating] Zeus Immortal • Morphling Immortal #2096 • Tusk Divine • Pangolier Ancient • QueenOfPain Legend • Tidehunter Archon • Earthshaker Crusader • ChaosKnight Guardian • Clockwerk Herald • Io Immortal #1
* Yes, it's Ranked (All Draft)
...
* Pop out native twitch chat
* Make Screenshot
* Cut 5px from the left
* 380px total width
*
